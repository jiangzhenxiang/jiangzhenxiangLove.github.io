! function(n) {
    ...
    var i = e(96),
        A = o(i),
        a = function() {
            return A.default.createElement("div", { className: "home-container" }, A.default.createElement("div", { className: "avatar-img" }, A.default.createElement("img", { src: "avatar.jpg", className: "avatar" })), A.default.createElement("div", { className: "home-info" },A.default.createElement("p", { className: "my-http" }, "有网的同学也可以用手机访问"), A.default.createElement("p", { className: "my-http" }, "jiangxu0926.github.io"), A.default.createElement("p", { className: "my-warning" }, "WARNING：以下内容纯属虚构,认真你就输了。。。"), A.default.createElement("p", { className: "my-name" }, "姜振祥"), A.default.createElement("p", { className: "my-word" }, "热爱编程，代码强迫症患者，一天不敲代码我浑身难受！"), A.default.createElement("p", { className: "my-profession" }, "前端开发攻城狮"), A.default.createElement("a", { href: "mailto:jiangxu926@163.com", target: "_blank", className: "my-email" }, "jiangxu926@163.com"))) };
    t.default = a }, function(n, t, e) { "use strict";
    ...
    var i = (e(1), e(11)),
        ...
        B = function(n) {
            ...
            return (0, p.default)(t, n), (0, u.default)(t, [{ key: "showModal", value: function(n) { this.setState({ visible: !0, src: n.currentTarget.getAttribute("data-src") }) } }, { key: "handleCancel", value: function() { this.setState({ visible: !1 }) } }, { key: "render", value: function() {
                    return g.default.createElement("div", { className: "contact-container" }, g.default.createElement("h1", { className: "contact-title" }, "联系我"), g.default.createElement("div", { className: "contact-content" }, g.default.createElement("div", { className: "contact-main" }, g.default.createElement("div", { className: "main-item", "data-src": "wx359642905.jpg", onClick: this.showModal }, g.default.createElement("div", { className: "item-icon" }, g.default.createElement("i", { className: "iconfont icon-weixin" })), g.default.createElement("div", { className: "item-content" }, "微信:jiangxu0926")), g.default.createElement("div", { className: "main-item", "data-src": "359642905.jpg", onClick: this.showModal }, g.default.createElement("div", { className: "item-icon" }, g.default.createElement("i", { className: "iconfont icon-qq" })), g.default.createElement("div", { className: "item-content" }, "QQ:359642905")), g.default.createElement("a", { href: "mailto:jiangxu926@163.com", target: "_blank", className: "main-item" }, g.default.createElement("div", { className: "item-icon" }, g.default.createElement("i", { className: "iconfont icon-email" })), g.default.createElement("div", { className: "item-content" }, "邮箱:jiangxu926@163.com"))), g.default.createElement("div", { className: "contact-other" }, g.default.createElement("p", { className: "other-title" }, "其他方式"), g.default.createElement("div", { className: "other-content" }, g.default.createElement("a", { className: "other-item", href: "https://github.com/jiangxu0926", target: "_blank" }, g.default.createElement("i", { className: "iconfont icon-github" })), g.default.createElement("a", { className: "other-item", href: "https://www.zhihu.com/", target: "_blank" }, g.default.createElement("i", { className: "iconfont icon-zhihu" })), g.default.createElement("a", { className: "other-item", href: "http://weibo.com/", target: "_blank" }, g.default.createElement("i", { className: "iconfont icon-weibo" }))))), g.default.createElement(A.default, { title: "", footer: "", width: "30%", visible: this.state.visible, onCancel: this.handleCancel }, g.default.createElement("div", { className: "big-img" }, g.default.createElement("img", { src: this.state.src, style: { maxWidth: "100%" } })))) } }]), t }(g.default.Component);
    t.default = B }]);
