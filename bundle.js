! function(n) {
    ...
    var i = e(96),
        A = o(i),
        a = function() {
            return A.default.createElement("div", { className: "home-container" }, A.default.createElement("div", { className: "avatar-img" }, A.default.createElement("img", { src: "avatar.jpg", className: "avatar" })), A.default.createElement("div", { className: "home-info" }, A.default.createElement("p", { className: "my-name" }, "姜振祥"), A.default.createElement("p", { className: "my-word" }, "热爱编程，患有代码强迫症的前端攻城狮！"), A.default.createElement("p", { className: "my-profession" }, "Talk is cheap,show you the code！"),A.default.createElement("p", { className: "my-profession" }, ""), A.default.createElement("a", { href: "mailto:jiangxu926@163.com", target: "_blank", className: "my-email" }, "jiangxu926@163.com"))) };
    t.default = a }, function(n, t, e) { "use strict";
