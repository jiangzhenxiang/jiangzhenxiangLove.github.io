! function(n) {
    ...
    var i = e(96),
        A = o(i),
        a = function() {
            return A.default.createElement("div", { className: "home-container" }, A.default.createElement("div", { className: "avatar-img" }, A.default.createElement("img", { src: "avatar.jpg", className: "avatar" })), A.default.createElement("div", { className: "home-info" },A.default.createElement("p", { className: "my-warning" }, "WARNING：以下内容纯属虚构,认真你就输了。。。"), A.default.createElement("p", { className: "my-warning" }, "有网的同学也可以用手机访问"), A.default.createElement("p", { className: "my-warning" }, "jiangxu0926.github.io"), A.default.createElement("p", { className: "my-name" }, "姜振祥"), A.default.createElement("p", { className: "my-word" }, "热爱编程，代码强迫症患者，一天不敲代码我浑身难受！"), A.default.createElement("p", { className: "my-profession" }, "前端开发攻城狮"), A.default.createElement("a", { href: "mailto:jiangxu926@163.com", target: "_blank", className: "my-email" }, "jiangxu926@163.com"))) };
    t.default = a }, function(n, t, e) { "use strict";
